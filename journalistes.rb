...
puts "Il y a  " + nbr_under.to_s + " _ en tout dans tous les pseudos confondus"

puts "et voici les journalistes triés : "

puts journalistes.sort_by(&:downcase)
